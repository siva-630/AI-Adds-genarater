...
export default function Hero() {
    ...
    const mainImageUrl = 'https://images.unsplash.com/photo-1511268559489-34b624fbfcf5?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D';
                ...
                <div className="max-w-6xl mx-auto px-4 min-h-screen max-md:w-screen max-md:overflow-hidden pt-32 md:pt-26 flex items-center justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div className="text-left">
                            ...
                            >
                                Upload your product photos and a model image — our AI transforms them into cinematic lifestyle visuals and 
                                scroll-stopping short videos built for ads, Reels, and brand campaigns.
                            </motion.p>
